...
const Register: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 relative">
            <div className="max-w-md w-full space-y-8 bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
                {showSuccess && (
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                minLength={6}
                                className="appearance-none block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                placeholder=""
